...
class _$SignUpParamsImpl implements _SignUpParams {
  ...
  @override
  String toString() {
    return 'SignUpParams(email: $email, password: $password, repeatPassword: $repeatPassword, username: $username, coordinates: $coordinates)';
  }
...
abstract class _SignUpParams implements SignUpParams {
  const factory _SignUpParams(
      ...
      required final List<double> coordinates}) = _$SignUpParamsImpl;
