...
// in locall_app/test/src/application/auth/cubit/check_if_taken_cubit_test.dart.
...
class MockCheckEmailExistsUsecase extends _i1.Mock
    implements _i3.CheckEmailExistsUsecase {
  MockCheckEmailExistsUsecase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Either<_i5.Failure, bool>> call(String? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [params],
...
/// A class which mocks [CheckUsernameExistsUsecase].
///
/// See the documentation for Mockito's code generation for more information.
class MockCheckUsernameExistsUsecase extends _i1.Mock
    implements _i6.CheckUsernameExistsUsecase {
  MockCheckUsernameExistsUsecase() {
    _i1.throwOnMissingStub(this);
  }
